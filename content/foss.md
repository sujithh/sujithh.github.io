...
- [View the ogg files I uploaded](https://github.com/KDE/klettres/tree/master/sounds/ml)
  _Description_: Explore all files I have made to support my mother tongue in this application. There are more than 500 OGG files. I would never forget the email I sent after creating them [here](https://mail.kde.org/pipermail/kde-edu/2009-January/003499.html).

## Docker

- [View all my commits](https://github.com/moby/moby/commits/master/?author=sharidasan)
  _Description_: Explore all contributions I've made to Docker.

## Yocto

### Poky

- [View all my commits in poky](https://git.yoctoproject.org/poky/log/?qt=grep&q=sujith)
  _Description_: Explore all contributions I've made to the Yocto project.
...
- [View all my commits in meta-minnow](https://git.yoctoproject.org/meta-minnow/log/?qt=grep&q=sujith)
  _Description_: Explore all contributions I've made to meta-minnow.
...
- [View all my commits](https://github.com/moodle/moodle/commits/main/?author=sharidas)
  _Description_: Explore all contributions I've made to Moodle.

## Articles Written

### Linux Gazette

- [My article on hacking the Canon A720IS digital camera with CHDK](https://linuxgazette.net/154/sujith.html)
  _Description_: For this article I bought my first camera. The joy I had flashing my changes to an SD card and getting it working was priceless.
